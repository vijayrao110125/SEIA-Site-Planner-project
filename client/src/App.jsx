...
import DeleteSessionModal from "./modals/DeleteSessionModal.jsx";
import SaveSessionModal from "./modals/SaveSessionModal.jsx";
import {
  AUTH_TOKEN_KEY,
  BATTERY_TYPES,
  EMPTY_COUNTS,
...
export default function App() {
  ...
  const wrapperClassName = theme === "dark" ? "dark" : "";
